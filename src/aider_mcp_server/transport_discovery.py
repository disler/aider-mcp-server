...
class DiscoveryService:
    ...
    async def register_discovery_callback(
        self, 
    ...
    async def notify_transport_available(
        self, 
        transport_name: str, 
            ...
            for callback in callbacks:
                try:
                    ...
                    ErrorHandler.log_exception(
                        e, 
                        context=f"discovery callback for transport '{transport_name}'",
        ...
        try:
            async with self._discovery_lock:
                ...
                available_transports = {
                    name: info 
                    for name, info in self._transport_info.items()
    ...
    async def discover_transports(self) -> List[str]:
        ...
        try:
            ...
            if hasattr(self._coordinator, '_transport_registry'):
    ...
    async def register_transport_with_coordinator(
        self, 
        transport_name: str, 
