...
class ConfigurationSystem:
        ...
        def merge_dicts(source: Dict[str, Any], destination: Dict[str, Any]) -> None:
            for key, value in source.items():
                if (isinstance(value, dict) and 
                    key in destination and 
                    isinstance(destination[key], dict)):
    ...
    def _get_value(self, config: Dict[str, Any], path: tuple) -> Optional[Any]:
        """
    ...
    def has(self, *path: str) -> bool:
        ...
        return (self._get_value(self._config, path) is not None or 
                self._get_value(self._default_config, path) is not None)
    ...
    def get_transport_config(self, transport_name: str) -> Dict[str, Any]:
        ...
        """
        return self.get("transports", transport_name, default={})
    ...
    def is_transport_enabled(self, transport_name: str) -> bool:
        ...
        """
        return self.get("transports", transport_name, "enabled", default=False)
