...
class TestWorkspaceManager:
    ...
    @pytest.mark.asyncio
    async def test_initialize_git_repo_success(self, manager: WorkspaceManager, mock_async_subprocess_exec: MagicMock, tmp_path: Path):
    ...
    @pytest.mark.asyncio
    async def test_initialize_git_repo_already_exists(self, manager: WorkspaceManager, mock_async_subprocess_exec: MagicMock, tmp_path: Path):
    ...
    @pytest.mark.asyncio
    async def test_initialize_git_repo_git_init_fails(self, manager: WorkspaceManager, mock_async_subprocess_exec: MagicMock, tmp_path: Path):
    ...
    @pytest.mark.asyncio
    async def test_initialize_git_repo_git_command_not_found(self, manager: WorkspaceManager, mock_async_subprocess_exec: MagicMock, tmp_path: Path):
    ...
    @pytest.mark.asyncio
    async def test_get_workspace_status_clean(self, manager: WorkspaceManager, mock_async_subprocess_exec: MagicMock, tmp_path: Path):
    ...
    @pytest.mark.asyncio
    async def test_get_workspace_status_dirty(self, manager: WorkspaceManager, mock_async_subprocess_exec: MagicMock, tmp_path: Path):
    ...
    @pytest.mark.asyncio
    async def test_get_workspace_status_git_command_fails(self, manager: WorkspaceManager, mock_async_subprocess_exec: MagicMock, tmp_path: Path):
        """Test git status when the git command itself fails."""
        workspace_path = await manager.create_client_workspace(self.CLIENT_ID)
        # Create .git directory manually to simulate git repo
        (workspace_path / ".git").mkdir()

        mock_async_subprocess_exec.return_value = create_mock_process(returncode=128, stderr="fatal: not a git repository")
    ...
    @pytest.mark.asyncio
    async def test_get_workspace_status_various(self, manager: WorkspaceManager, mock_async_subprocess_exec: MagicMock, tmp_path: Path):
    ...
    @pytest.mark.asyncio
    async def test_workspace_isolation(self, manager: WorkspaceManager, mock_async_subprocess_exec: MagicMock, tmp_path: Path):
