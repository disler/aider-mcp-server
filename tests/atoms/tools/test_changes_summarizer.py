...
class TestChangesSummarizer:
    ...
    def test_summarize_changes_empty(self):
        ...
        assert ("No meaningful changes detected" in result["summary"] or
                "No git-tracked changes detected" in result["summary"])
...
"""
    ...
    def test_get_file_status_summary(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            result = get_file_status_summary(
                ["new_file.py", "empty_file.py"], 
    ...
    def test_get_file_status_summary_nonexistent(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Updated to work with new response format
            assert ("No changes detected" in result["status_summary"] or
                    "No filesystem changes detected" in result["status_summary"])
