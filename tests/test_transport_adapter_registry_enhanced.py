...
from aider_mcp_server.mcp_types import RequestParameters
...
class TestEnhancedTransportAdapterRegistry(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_initialize_adapter_deprecated_warning(self):
        ...
        self.registry._transport_metadata["sse"] = MagicMock(
            ...
            capabilities=MagicMock(
                deprecated=True,
                deprecation_message="Legacy SSE - migrate to HTTP Streamable"
            )
        )
    ...
    def test_determine_transport_status(self):
        ...
        self.assertEqual(
            self.registry._determine_transport_status(recommended_caps),
            TransportStatus.RECOMMENDED
        )
        ...
        self.assertEqual(
            self.registry._determine_transport_status(deprecated_caps),
            TransportStatus.DEPRECATED
        )
    ...
    async def test_shutdown_all(self):
        ...
        self.registry._adapter_instances = {
